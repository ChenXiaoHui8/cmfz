...
<div class="login">
    <form id="loginForm" action="${pageContext.request.contextPath}/loginAdmin" method="post">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="enCode" name="Kaptcha" class="text captcha" maxlength="4"
                           autocomplete="off"/>
                    <img width="60" height="27" id="captchaImage" class="captchaImage" src="getKaptcha" title="点击更换验证码"
                         onclick="pic()"/>
                </td>
            </tr>
            <tr>
